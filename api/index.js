...
var ADMIN_SECRET = sanitizeEnvVar(process.env.ADMIN_SECRET) || sanitizeEnvVar(process.env.SUPABASE_DB_PASSWORD) || (isTestEnv ? "test_admin_secret" : "");
var INITIAL_ADMIN_EMAIL = sanitizeEnvVar(process.env.INITIAL_ADMIN_EMAIL) || "s.lahaie07@gmail.com";
var INITIAL_ADMIN_PASSWORD = sanitizeEnvVar(process.env.INITIAL_ADMIN_PASSWORD) || sanitizeEnvVar(process.env.ADMIN_SECRET);
...
var getDb = () => {
  try {
    return { ...createEmptyDb(), ...JSON.parse(fs.readFileSync(DB_PATH, "utf8")) };
  } catch {
