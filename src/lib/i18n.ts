...
export const i18n = {
  fr: {
    ...
    superAdminClients: {
      ...
      subtitle: "Vue d'ensemble de la clientèle du réseau (Lecture seule)",
  ...
  en: {
    ...
    superAdminClients: {
      title: "Registry",
      titleAccent: "Global Clients.",
      subtitle: "Network client overview (read-only)",
  ...
  ar: {
    ...
    superAdminClients: {
      ...
      subtitle: "نظرة عامة على عملاء الشبكة (للقراءة فقط)",
