...
export const i18n = {
  fr: {
    ...
    auth: {
      ...
      createFileDesc: "Ouvrir votre espace client sécurisé",
      loginTitle: "S'identifier.",
      registerTitle: "Nouveau Dossier Client.",
      loginSubtitle: "Rapprocher vos flux financiers",
      registerSubtitle: "Inscription réservée aux clients",
      registerClientNote: "Votre comptable partenaire vous sera assigné par l'équipe ComptaFlow après validation du dossier.",
  ...
  en: {
    ...
    auth: {
      ...
      createFileDesc: "Open your secure client portal",
      loginTitle: "Sign in.",
      registerTitle: "New Client Account.",
      loginSubtitle: "Connect your financial flows",
      registerSubtitle: "Registration for clients only",
      registerClientNote: "Your partner bookkeeper will be assigned by the ComptaFlow team after your file is validated.",
      fullName: "Full name",
      email: "Email address",
      password: "Password",
  ...
  ar: {
    ...
    auth: {
      ...
      createFile: "فتح ملف",
      createFileDesc: "فتح بوابة العميل الآمنة",
      loginTitle: "تسجيل الدخول.",
      registerTitle: "حساب عميل جديد.",
      loginSubtitle: "الوصول إلى مساحتك المالية",
      registerSubtitle: "التسجيل مخصص للعملاء فقط",
      registerClientNote: "سيُعيَّن محاسبك الشريك من قبل فريق ComptaFlow بعد التحقق من ملفك.",
      fullName: "الاسم الكامل",
      email: "البريد الإلكتروني",
      password: "كلمة المرور",
      partnerLabel: "المحاسب الشريك",
      noPartner: "لا يوجد محاسب شريك مسجل. أنشئ حساب محاسب أولاً أو سجّل الدخول كمسؤول أعلى.",
      partnersLoading: "جاري تحميل المحاسبين الشركاء…",
      partnersLoadError: "تعذّر تحميل قائمة الشركاء. قد تكون ترحيلات قاعدة البيانات غير مكتملة.",
      contactSupportHint: "لفتح ملف عميل، تواصل مع فريقنا — سنربطك بمحاسب شريك.",
      contactSupport: "الاتصال بالدعم",
      resendEmail: "إعادة إرسال بريد التأكيد",
      submitLogin: "تسجيل الدخول",
      submitRegister: "إنشاء الحساب",
      switchToRegister: "لست مسجلاً؟ افتح ملفاً",
      switchToLogin: "مسجل مسبقاً؟ تسجيل الدخول",
