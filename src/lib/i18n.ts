...
export const i18n = {
  ...
  en: {
    ...
    faq: {
      ...
      a2: "Yes. All files are encrypted in transit (TLS) and stored in a secure Canadian data center, accessible only by you and your accountant. No sensitive documents are sent over regular email.",
