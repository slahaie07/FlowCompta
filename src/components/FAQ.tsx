  ...
  const faqs = [
    {
      ...
      answer: "Absolument. ComptaFlow utilise le chiffrement AES-256 (niveau bancaire) pour tous vos documents. Vos données sont isolées via des politiques RLS (Row Level Security) garantissant que seul vous et votre expert CPA assigné pouvez y accéder.",
      icon: Lock
    },
    {
    ...
    },
    {
      ...
      answer: "Dès que vous téléversez un document ou saisissez une transaction, votre CPA est notifié. Les échanges se font via notre canal direct chiffré, éliminant les risques liés aux courriels non sécurisés.",
      icon: ShieldCheck
    },
    {
