        ...
        <div>
          ...
          <div className="flex items-center gap-4 mt-3">
            <div className="flex items-center gap-2 px-3 py-1 bg-gold/10 border border-gold/20 rounded-full">
              ...
              <span className="text-gold text-[9px] font-black uppercase tracking-[0.2em]">Chiffrement AES-256 Certifié</span>
            </div>
            <span className="w-8 h-[1px] bg-white/10"></span>
            <p className="text-slate-600 text-[10px] font-black uppercase tracking-[0.4em]">Vault Virtuel Haute-Fidélité</p>
          </div>
        </div>
