  ...
  const faqs = [
    {
      ...
      answer: "Absolument. ComptaFlow utilise le chiffrement AES-256 (niveau bancaire) pour tous vos documents. Vos données sont isolées via des politiques RLS (Row Level Security) garantissant que seul vous et votre commis comptable assigné pouvez y accéder.",
      icon: Lock
    },
    {
    ...
    },
    {
      ...
      answer: "Dès que vous téléversez un document ou saisissez une transaction, votre commis comptable est notifié. Les échanges se font via notre canal direct chiffré, éliminant les risques liés aux courriels non sécurisés.",
      icon: ShieldCheck
    },
    {
  ...
  return (
    <div className="space-y-12 max-w-4xl mx-auto pb-20">
      ...
      <Card className="p-10 border-sapphire/20 bg-sapphire/[0.02] text-center space-y-6">
         ...
         <p className="text-sm text-slate-500 max-w-lg mx-auto">Notre équipe de support technique et nos commis comptables sont disponibles pour vous répondre sous 24 heures.</p>
